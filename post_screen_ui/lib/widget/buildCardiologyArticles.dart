...
class BuildCardiologyArticleList extends StatefulWidget {
  const BuildCardiologyArticleList({Key? key}) : super(key: key);

  @override
  _BuildCardiologyArticleListState createState() =>
      _BuildCardiologyArticleListState();
}

class _BuildCardiologyArticleListState extends State<BuildCardiologyArticleList> {
